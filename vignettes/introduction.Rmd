...
```{r}
    data(movies.list)
    length(unique(movies.list$movies.urls))
```
...
```{r}
    # Search for a title
    searchTitle(pattern = 'expendables', moviesDB = movies.list)
    searchTitle(pattern = 'The Expendables', moviesDB = movies.list)
    searchTitle(pattern = 'The Expendables', moviesDB = movies.list, exact.match = TRUE)
```
...
```{r}
    ...
    theexpendables <- fetchMovie(title = 'The expendables', moviesDB = movies.list)
...
```{r}
    ...
    searchTitle(pattern = 'greatest showman', moviesDB = movies.list)
    greatestshowman <- fetchMovie(title = 'The Greatest Showman', moviesDB = movies.list)
    
    searchTitle(pattern = 'The Post', moviesDB = movies.list)
    thepost <- fetchMovie(title = 'The Post', moviesDB = movies.list)
```
...
```{r}
    list.movies <- searchTitle('star wars', moviesDB = movies.list, return.list = TRUE)
    starwarsList <- fetchMoviesList(titles = list.movies, moviesDB = movies.list)
    starwarsList
    class(starwarsList)
```